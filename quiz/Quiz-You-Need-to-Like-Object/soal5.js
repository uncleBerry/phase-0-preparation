...
function deleteUndefinedKeys(data) {
  ...
  // check if the input is a zero array, then return `No data`

  // Make nested loop, the first loop for checking every elemen object inside array and the second loop is for indetifying key:value object is undifinede or not
